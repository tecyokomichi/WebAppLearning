...
func main() {
	...
	var (
		sampleAPIEndpoints *sampleapi.Endpoints
	)
	{
		sampleAPIEndpoints = sampleapi.NewEndpoints(sampleAPISvc)
	}
	...
	case "localhost":
		{
			...
			handleHTTPServer(ctx, u, sampleAPIEndpoints, &wg, errc, logger, *dbgF)
		}
