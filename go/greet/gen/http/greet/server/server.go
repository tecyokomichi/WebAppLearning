...
// Server lists the greet service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Hello  http.Handler
}
...
// New instantiates HTTP handlers for all the greet service endpoints using the
...
func (s *Server) Service() string { return "greet" }
...
// Mount configures the mux to serve the greet endpoints.
func Mount(mux goahttp.Muxer, h *Server) {
	MountHelloHandler(mux, h.Hello)
}

// MountHelloHandler configures the mux to serve the "greet" service "hello"
// endpoint.
...
// calls the "greet" service "hello" endpoint.
