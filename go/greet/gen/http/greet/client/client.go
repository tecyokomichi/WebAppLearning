...
// Client lists the greet service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the greet service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// Hello returns an endpoint that makes HTTP requests to the greet service
// hello server.
func (c *Client) Hello() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("greet", "hello", err)
		}
